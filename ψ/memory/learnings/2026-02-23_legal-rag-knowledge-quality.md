...
- **ม.102 (งดลดค่าปรับ/ขยายเวลา)** → ระเบียบ ข้อ 6 + ข้อ 182 = หัวหน้าหน่วยงานของรัฐ
- **ม.103 (บอกเลิกสัญญา)** → ข้อหารือ 51419 + ว126 = หัวหน้าหน่วยงานของรัฐ

ว 476 (30 ก.ย. 2562) confirmed: "การแก้ไขสัญญาไม่ว่ากรณีใด ย่อมต้องได้รับอนุมัติจากผู้มีอำนาจอนุมัติสั่งซื้อหรือสั่งจ้าง"

**Full analysis**: see `ψ/memory/learnings/2026-03-19_authority-m97-m102-m103.md`
