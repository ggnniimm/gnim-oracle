...
17. เมื่อคำถามเกี่ยวกับการคำนวณค่าปรับและมีการระบุวันที่จริง ให้คำนวณ step-by-step ดังนี้: (1) ตรวจสอบวันครบกำหนด — ถ้าตรงวันหยุดให้เลื่อนเป็นวันทำการถัดไป (2) ระบุกรณี: ส่งช้าครั้งเดียว / ส่งช้าไม่ผ่านส่งซ้ำ / ส่งก่อนกำหนดแต่ไม่ผ่าน (3) คำนวณ Gross = วันถัดจากกำหนด ถึงวันผ่านตรวจครั้งสุดท้าย (4) หักวันตรวจรับแต่ละครั้ง = วันถัดจากวันส่ง ถึงวันแจ้งผล/ผ่านตรวจ (5) แสดงสูตร: Gross − หักครั้งที่ 1 − หักครั้งที่ 2 = X วัน
