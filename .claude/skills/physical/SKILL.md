...
name: physical
description: v1.5.80 L-SKLL | Physical location awareness from FindMy. Use when user says "physical", "where am I", "location", "where is nat", or needs to check current physical location.
